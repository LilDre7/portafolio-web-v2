    ...
    <>
      <div className="min-h-screen bg-black text-white">
        ...
        {isModalOpen && (
          // Aqui va el modal
          <div
            className={`fixed inset-0 z-50 flex items-start justify-center pt-[14vh] md:pt-[20vh] p-4 transition-opacity duration-300 ${
              isModalOpen
          ...
          >
            ...
            >
              {/* Card principal */}
              <div className="relative bg-black backdrop-blur-xl rounded-2xl shadow-2xl border-2 border-white overflow-hidden">
                {/* Search bar */}
                <div className="flex items-center gap-3 px-5 py-4 border-b-2 border-white/20">
                  ...
                  <input
                    ...
                    className="flex-1 bg-transparent text-white text-sm placeholder-white/40 outline-none font-light"
                    autoFocus
                    onKeyDown={(e) => {
                      if (e.key === "Escape") {
                        setIsModalOpen(false);
                ...
                <div className="px-5 py-3 border-b border-white/10">
                  ...
                  <div className="flex items-center gap-2 flex-wrap">
                    <button className="px-3 py-1.5 bg-white/10 hover:bg-white/20 text-white text-xs rounded-lg border border-white/20 transition-colors flex items-center gap-2">
                      <svg
                    ...
                    <button className="px-3 py-1.5 hover:bg-white/10 text-white/60 text-xs rounded-lg transition-colors flex items-center gap-1.5">
                      More
                      <svg
                        className="w-3 h-3"
                        fill="none"
                ...
                <div className="px-5 py-3 border-b border-white/10">
                  <div className="flex items-center justify-between mb-3">
                    <p className="text-xs text-white/50 font-medium">
                      Contact methods <span className="text-white/30">4</span>
                    </p>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <Link
                      ...
                      className="flex items-center gap-3 px-3 py-2.5 hover:bg-white/10 rounded-lg transition-all duration-150 group border border-transparent hover:border-white/20"
                    >
                      <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center group-hover:bg-white/20 transition-colors border border-white/20">
                        <svg
                      ...
                      <div className="hidden sm:flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <kbd className="px-1.5 py-0.5 bg-white/10 text-white/70 text-[10px] rounded border border-white/20 font-mono">
                          ↵
                        </kbd>
                      </div>
                      <button className="p-1 hover:bg-white/10 rounded text-white/60 hover:text-white transition-colors">
                        <svg
                          className="w-4 h-4"
                          fill="none"
                          stroke="currentColor"
                ...
                <div className="px-5 py-3 border-b border-white/10">
                  ...
                  <div className="space-y-1">
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 px-3 py-2 hover:bg-white/10 rounded-lg transition-all duration-150 group border border-transparent hover:border-white/20"
                    >
                      <div className="w-6 h-6 rounded bg-white/10 flex items-center justify-center group-hover:bg-white/20 transition-colors border border-white/20">
                        <span className="text-xs text-white">+</span>
                      </div>
                      <span className="text-sm text-white">View portfolio</span>
                      <kbd className="ml-auto px-1.5 py-0.5 bg-white/10 text-white/70 text-[10px] rounded border border-white/20 font-mono hidden sm:inline-block">
                        E
                      </kbd>
                    </Link>
                    <button className="w-full flex items-center gap-3 px-3 py-2 hover:bg-white/10 rounded-lg transition-all duration-150 group border border-transparent hover:border-white/20">
                      <div className="w-6 h-6 rounded bg-white/10 flex items-center justify-center group-hover:bg-white/20 transition-colors border border-white/20">
                        <span className="text-xs text-white">+</span>
                      </div>
                      <span className="text-sm text-white">Download vCard</span>
                      <kbd className="ml-auto px-1.5 py-0.5 bg-white/10 text-white/70 text-[10px] rounded border border-white/20 font-mono hidden sm:inline-block">
                        S
                      </kbd>
                    </button>
                ...
                {/* Footer */}
                <div className="px-5 py-2.5 bg-white/5">
                  <div className="flex items-center justify-between text-[10px] text-white/40">
                    ...
                    <div className="hidden sm:flex items-center gap-2">
                      <kbd className="px-1.5 py-0.5 bg-white/10 rounded border border-white/20 font-mono text-white/60">
                        ESC
                      </kbd>
                      <span>to close</span>
                    </div>
