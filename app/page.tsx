  ...
  return (
    <>
      <div className="min-h-screen bg-black text-white">
        ...
        {isModalOpen && (
          <div
            className={`fixed inset-0 z-50 overflow-hidden transition-all duration-500 ${isModalOpen ? "opacity-100" : "opacity-0"
              } bg-black`}
            onClick={() => setIsModalOpen(false)}
          >
            <div
              className={`w-full h-full flex flex-col items-center justify-center p-8 relative delay-150 transition-all duration-700 ease-in-out animate-click ${isModalOpen
